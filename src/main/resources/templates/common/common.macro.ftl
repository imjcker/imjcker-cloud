...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>api-manager</b> 1.1.2-SNAPSHOT
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://www.imjcker.com/" target="_blank" >imjcker</a>&nbsp;
                <a href="https://github.com/imjcker/api-manager" target="_blank" >github</a>
